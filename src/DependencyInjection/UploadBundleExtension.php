...
class UploadBundleExtension extends Extension implements PrependExtensionInterface
{
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('upload_bundle.image_resize.max_width', $config['image_resize']['max_width']);
        $container->setParameter('upload_bundle.image_resize.max_height', $config['image_resize']['max_height']);
